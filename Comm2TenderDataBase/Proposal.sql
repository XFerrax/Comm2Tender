...
(
    ...
    [PositionPrice] DECIMAL(12, 3) NOT NULL, 
    [DeliveryCost] DECIMAL(12, 3) NOT NULL, 
    [DeliveryTime] INT NOT NULL, 
    [PrepaidExpense1] DECIMAL(12, 3) NOT NULL, 
    [PrepaidExpense2] DECIMAL(12, 3) NOT NULL, 
    [PrepaidExpense3] DECIMAL(12, 3) NOT NULL, 
    [PeriodOfExecution1] INT NOT NULL, 
    [PeriodOfExecution2] INT NOT NULL, 
    [PeriodOfExecution3] INT NOT NULL, 
    [PostPaymant1] DECIMAL(12, 3) NOT NULL, 
    [PostPaymant2] DECIMAL(12, 3) NOT NULL, 
    [PostPaymant3] DECIMAL(12, 3) NOT NULL, 
